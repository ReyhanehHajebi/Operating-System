...
int main(int argc, char* argv[]){
  ...
  14:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for (int i = 0; i < NUM_FORKS; i++){
        int pid = fork();
  18:	e8 8e 02 00 00       	call   2ab <fork>
        if (pid == 0){
  1d:	85 c0                	test   %eax,%eax
  1f:	74 1e                	je     3f <main+0x3f>
    for (int i = 0; i < NUM_FORKS; i++){
  ...
  2d:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    while (wait() != -1);
  30:	e8 86 02 00 00       	call   2bb <wait>
  35:	83 f8 ff             	cmp    $0xffffffff,%eax
  38:	75 f6                	jne    30 <main+0x30>
    exit();
  3a:	e8 74 02 00 00       	call   2b3 <exit>
           sleep(1000000);
  3f:	83 ec 0c             	sub    $0xc,%esp
  42:	68 40 42 0f 00       	push   $0xf4240
  47:	e8 f7 02 00 00       	call   343 <sleep>
           for (long long j = 0; j < 1000000000000; j++){
  4c:	83 c4 10             	add    $0x10,%esp
  4f:	eb df                	jmp    30 <main+0x30>
  51:	66 90                	xchg   %ax,%ax
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
