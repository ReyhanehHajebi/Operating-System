...
extern int sys_set_sjf_process(void);
extern int sys_print_schedule_info(void);
extern int sys_printvir(void);
extern int sys_printphy(void);
extern int sys_mapex(void);
...
[SYS_set_sjf_process]  sys_set_sjf_process,
