...
_count_num_of_digit:     file format elf32-i386
...
main(int argc, char* argv[]){
  ...
  2c:	e8 42 03 00 00       	call   373 <count_num_of_digit>
    asm volatile(
  31:	89 f3                	mov    %esi,%ebx
  ...
  33:	50                   	push   %eax
  34:	53                   	push   %ebx
  35:	68 a9 07 00 00       	push   $0x7a9
  3a:	6a 01                	push   $0x1
  3c:	e8 1f 04 00 00       	call   460 <printf>
    exit();
  41:	83 c4 20             	add    $0x20,%esp
  44:	e8 8a 02 00 00       	call   2d3 <exit>
        printf(1, "Usage: count_num_of_digit <num>\n");
  49:	50                   	push   %eax
  4a:	50                   	push   %eax
...
00000060 <count_num_of_digit_handler>:
count_num_of_digit_handler(int num){
  ...
  6a:	89 db                	mov    %ebx,%ebx
  6c:	89 db                	mov    %ebx,%ebx
    int result = count_num_of_digit();
  6e:	e8 00 03 00 00       	call   373 <count_num_of_digit>
    asm volatile(
  73:	89 db                	mov    %ebx,%ebx
}
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 d0 07 00 00 	jmp    *0x7d0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba c7 07 00 00       	mov    $0x7c7,%edx
        while(*s != 0){
