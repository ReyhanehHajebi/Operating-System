...
main(void)
{
  ...
  52:	e8 89 04 00 00       	call   4e0 <printf>
    printf(1, "Mohammad Souri \nSafoora Alavi Panah\nReyhaneh Hajebi\n" );
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 58 08 00 00       	push   $0x858
  5e:	6a 01                	push   $0x1
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 559:	ff 24 85 94 08 00 00 	jmp    *0x894(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 667:	90                   	nop
          s = "(null)";
 668:	ba 8d 08 00 00       	mov    $0x88d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 a0 0b 00 00    	mov    %edx,0xba0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d a0 0b 00 00    	mov    0xba0,%edi
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
