...
int main(int argc,char* argv[]) { 
   ...
   e:	51                   	push   %ecx
    ...
    printvir();
   f:	e8 5f 03 00 00       	call   373 <printvir>
    printphy();
  14:	e8 62 03 00 00       	call   37b <printphy>
    char* a = (char*)(mapex(8192));
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
  21:	e8 5d 03 00 00       	call   383 <mapex>
  26:	89 c3                	mov    %eax,%ebx
    printvir();
  28:	e8 46 03 00 00       	call   373 <printvir>
    printphy();
  2d:	e8 49 03 00 00       	call   37b <printphy>
    a[0] = 'a';
  32:	c6 03 61             	movb   $0x61,(%ebx)
    printvir();
  35:	e8 39 03 00 00       	call   373 <printvir>
    printphy();
  3a:	e8 3c 03 00 00       	call   37b <printphy>
    a[4096] = 'b';
  3f:	c6 83 00 10 00 00 62 	movb   $0x62,0x1000(%ebx)
    printvir();
  46:	e8 28 03 00 00       	call   373 <printvir>
    printphy();
  4b:	e8 2b 03 00 00       	call   37b <printphy>
 ...
 5e1:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 74 0a 00 00    	mov    %edx,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6bf:	73 4f                	jae    710 <malloc+0xa0>
    ...
    if(p == freep)
 6c1:	8b 3d 74 0a 00 00    	mov    0xa74,%edi
 ...
 6ea:	e8 f1 fe ff ff       	call   5e0 <free>
  return freep;
 6ef:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 71c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 71f:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 ...
 72f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 78 0a 00 00       	mov    $0xa78,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
