...
_set_sjf_process:     file format elf32-i386
...
int main(int argc,char* argv[]){
  ...
  46:	53                   	push   %ebx
  47:	50                   	push   %eax
  48:	e8 13 00 00 00       	call   60 <set_process_sjf>
    exit();
...
00000060 <set_process_sjf>:
{
  ...
  6e:	7e 60                	jle    d0 <set_process_sjf+0x70>
    if (burst < 0)
  70:	85 d2                	test   %edx,%edx
  72:	78 44                	js     b8 <set_process_sjf+0x58>
    int res = set_sjf_process(pid, burst);
  74:	83 ec 08             	sub    $0x8,%esp
  77:	52                   	push   %edx
  78:	50                   	push   %eax
  79:	e8 75 03 00 00       	call   3f3 <set_sjf_process>
    if (res < 0)
  7e:	83 c4 10             	add    $0x10,%esp
  81:	85 c0                	test   %eax,%eax
  83:	78 1b                	js     a0 <set_process_sjf+0x40>
        printf(1, "SJF params set successfully\n");
  85:	c7 45 0c 33 08 00 00 	movl   $0x833,0xc(%ebp)
  8c:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
  93:	c9                   	leave  
        printf(1, "SJF params set successfully\n");
  94:	e9 37 04 00 00       	jmp    4d0 <printf>
  99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(1, "Error setting SJF params\n");
  a0:	c7 45 0c 19 08 00 00 	movl   $0x819,0xc(%ebp)
  a7:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
  ae:	c9                   	leave  
        printf(1, "Error setting SJF params\n");
  af:	e9 1c 04 00 00       	jmp    4d0 <printf>
  b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printf(1, "Invalid burst time\n");
  b8:	c7 45 0c 05 08 00 00 	movl   $0x805,0xc(%ebp)
  bf:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
  c6:	c9                   	leave  
        printf(1, "Invalid burst time\n");
  c7:	e9 04 04 00 00       	jmp    4d0 <printf>
  cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printf(1, "Invalid pid\n");
  d0:	c7 45 0c f8 07 00 00 	movl   $0x7f8,0xc(%ebp)
  d7:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
  de:	c9                   	leave  
        printf(1, "Invalid pid\n");
  df:	e9 ec 03 00 00       	jmp    4d0 <printf>
  e4:	66 90                	xchg   %ax,%ax
  e6:	66 90                	xchg   %ax,%ax
  e8:	66 90                	xchg   %ax,%ax
  ea:	66 90                	xchg   %ax,%ax
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 62 08 00 00       	mov    $0x862,%edx
        while(*s != 0){
