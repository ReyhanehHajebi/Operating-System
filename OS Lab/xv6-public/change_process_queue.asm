...
_change_process_queue:     file format elf32-i386
...
int main(int argc,char* argv[]){
  ...
  1b:	53                   	push   %ebx
  1c:	53                   	push   %ebx
  1d:	68 29 08 00 00       	push   $0x829
  22:	6a 01                	push   $0x1
  24:	e8 a7 04 00 00       	call   4d0 <printf>
        exit();
  29:	e8 15 03 00 00       	call   343 <exit>
    }

    set_queue(atoi(argv[1]),atoi(argv[2]));
  2e:	83 ec 0c             	sub    $0xc,%esp
  31:	ff 76 08             	push   0x8(%esi)
  34:	e8 97 02 00 00       	call   2d0 <atoi>
  39:	89 c3                	mov    %eax,%ebx
  3b:	58                   	pop    %eax
  3c:	ff 76 04             	push   0x4(%esi)
  3f:	e8 8c 02 00 00       	call   2d0 <atoi>
  44:	5a                   	pop    %edx
  45:	59                   	pop    %ecx
  46:	53                   	push   %ebx
  47:	50                   	push   %eax
  48:	e8 13 00 00 00       	call   60 <set_queue>
    exit();
  4d:	e8 f1 02 00 00       	call   343 <exit>
  52:	66 90                	xchg   %ax,%ax
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
...
void set_queue(int pid,int new_queue) {
  ...
  6d:	7e 69                	jle    d8 <set_queue+0x78>
    if(new_queue < 1 || new_queue > 4) {
  6f:	8d 46 ff             	lea    -0x1(%esi),%eax
  72:	83 f8 03             	cmp    $0x3,%eax
  75:	77 51                	ja     c8 <set_queue+0x68>
    int res = change_process_queue(pid, new_queue);
  77:	83 ec 08             	sub    $0x8,%esp
  7a:	56                   	push   %esi
  7b:	53                   	push   %ebx
  7c:	e8 6a 03 00 00       	call   3eb <change_process_queue>
    if(res < 0) {
  81:	83 c4 10             	add    $0x10,%esp
  84:	85 c0                	test   %eax,%eax
  86:	78 20                	js     a8 <set_queue+0x48>
        printf(1,"process with pid = %d changed queue from %d to %d\n",pid , res , new_queue);
  88:	83 ec 0c             	sub    $0xc,%esp
  8b:	56                   	push   %esi
  8c:	50                   	push   %eax
  8d:	53                   	push   %ebx
  8e:	68 3c 08 00 00       	push   $0x83c
  93:	6a 01                	push   $0x1
  ...
  a8:	c7 45 0c 14 08 00 00 	movl   $0x814,0xc(%ebp)
  af:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
  b6:	8d 65 f8             	lea    -0x8(%ebp),%esp
  b9:	5b                   	pop    %ebx
  ba:	5e                   	pop    %esi
  bb:	5d                   	pop    %ebp
        printf(1,"Eror changing queue\n");
  bc:	e9 0f 04 00 00       	jmp    4d0 <printf>
  c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"invalid queue\n");
  c8:	c7 45 0c 05 08 00 00 	movl   $0x805,0xc(%ebp)
  cf:	eb de                	jmp    af <set_queue+0x4f>
  d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"invalid pid\n");
  d8:	c7 45 0c f8 07 00 00 	movl   $0x7f8,0xc(%ebp)
  df:	eb ce                	jmp    af <set_queue+0x4f>
  e1:	66 90                	xchg   %ax,%ax
  e3:	66 90                	xchg   %ax,%ax
  e5:	66 90                	xchg   %ax,%ax
  e7:	66 90                	xchg   %ax,%ax
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 6f 08 00 00       	mov    $0x86f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 b8 0b 00 00 bc 	movl   $0xbbc,0xbb8
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf bc 0b 00 00       	mov    $0xbbc,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 7e2:	00 00 00 
    if(p->s.size >= nunits){
